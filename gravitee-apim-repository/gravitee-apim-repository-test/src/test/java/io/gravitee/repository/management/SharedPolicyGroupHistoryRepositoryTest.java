...
public class SharedPolicyGroupHistoryRepositoryTest extends AbstractManagementRepositoryTest {
    ...
    @Test
    public void should_searchLastDeployedAtGroupById() throws TechnicalException {
        final var criteria = SharedPolicyGroupHistoryCriteria.builder().environmentId("environmentId").build();

        final var page1 = sharedPolicyGroupHistoryRepository.searchLastDeployedAtGroupById(
            criteria,
            new PageableBuilder().pageNumber(0).pageSize(2).build()
        );
        ...
        final var page2 = sharedPolicyGroupHistoryRepository.searchLastDeployedAtGroupById(
            criteria,
    ...
    @Test
    public void should_searchLastDeployedAtGroupById_with_no_result() throws TechnicalException {
        final var criteria = SharedPolicyGroupHistoryCriteria.builder().environmentId("unknown").build();

        final var page = sharedPolicyGroupHistoryRepository.searchLastDeployedAtGroupById(
            criteria,
            new PageableBuilder().pageNumber(0).pageSize(2).build()
        );
        assertThat(page).isNotNull();
    ...
    @Test
    public void should_searchLastDeployedAtGroupById_with_no_result_with_unknown_environment() throws TechnicalException {
        final var criteria = SharedPolicyGroupHistoryCriteria.builder().environmentId("unknown").build();
    ...
    @Test
    public void should_searchLastDeployedAtGroupById_with_lifecycleState_criteria() throws TechnicalException {
        final var criteria = SharedPolicyGroupHistoryCriteria
            .builder()
            .environmentId("environmentId")
