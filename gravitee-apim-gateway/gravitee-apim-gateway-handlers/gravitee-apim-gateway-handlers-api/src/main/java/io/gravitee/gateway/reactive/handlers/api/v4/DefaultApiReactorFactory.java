...
public class DefaultApiReactorFactory extends AbstractReactorFactory<Api> {
    ...
    protected ApiReactor<Api> buildApiReactor(
        ...
        final PolicyChainFactory policyChainFactory = new HttpPolicyChainFactory(api.getId(), policyManager, isApiTracingEnabled(api));

        final io.gravitee.gateway.reactive.v4.policy.PolicyChainFactory v4PolicyChainFactory = policyChainFactory(api, policyManager);
