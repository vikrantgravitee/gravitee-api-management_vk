...
public enum Key {
    ...
    PORTAL_NEXT_BANNER("portal.next.banner", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_TITLE("portal.next.banner", "Welcome to Gravitee Developer Portal!", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_SUBTITLE("portal.next.banner", "Discover powerful APIs to supercharge your projects.", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_ENABLED("portal.next.banner", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_BUTTON("portal.next.banner", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_BUTTON_TITLE("portal.next.banner",  new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_BUTTON_TEXT("portal.next.banner", "Get started", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_BUTTON_ORDER("portal.next.banner", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_BUTTON_LINK("portal.next.banner", new HashSet<>(singletonList(ENVIRONMENT))),
