...
public class DeleteSubscriptionSpecUseCase {
    ...
    private final SubscriptionCrudService crudService;
    private final DeleteSubscriptionDomainService deleteService;

    public void execute(Input input) {
        var subscription = crudService.get(input.id);
        deleteService.delete(subscription, input.auditInfo);
    }
}
